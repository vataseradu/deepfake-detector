"""
Test rapid pe imagini reale pentru a vedea ce valori primesc
"""
...
# Test 10 imagini reale
print("Testing 10 REAL images:")
print("="*60)

real_files = [f for f in os.listdir(REAL_PATH) if f.lower().endswith(('.jpg', '.jpeg', '.png'))][:10]
